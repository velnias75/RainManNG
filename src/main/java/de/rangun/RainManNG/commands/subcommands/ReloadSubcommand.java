 ...
 *
 */
final class ReloadSubcommand extends AbstractRainManNGSubcommand {

	protected ReloadSubcommand(final RainManNGPlugin plugin, final String[] args) {
		super(plugin, args);
	}
	...
	protected void doCommand(final CommandSender sender) {
		...
		sender.sendMessage(msgBase + "config reloaded]");
	}
}
